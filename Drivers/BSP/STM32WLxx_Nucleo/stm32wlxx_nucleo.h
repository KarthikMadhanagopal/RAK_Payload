...
typedef enum 
{
  ...
  LED3 = 2,
  /* Color led aliases */
  LED_BLUE   = VBAT_MEAS_EN,
  LED_GREEN  = SNSR_PWR_EN_1,
  LED_RED    = LED3
}Led_TypeDef;
...
#define SNSR_PWR_EN_1_PIN                                GPIO_PIN_0
#define SNSR_PWR_EN_1_GPIO_PORT                          GPIOA
#define SNSR_PWR_EN_1_GPIO_CLK_ENABLE()                  __HAL_RCC_GPIOA_CLK_ENABLE()
#define SNSR_PWR_EN_1_GPIO_CLK_DISABLE()                 __HAL_RCC_GPIOA_CLK_DISABLE()

#define VBAT_MEAS_EN_PIN                                GPIO_PIN_1
#define VBAT_MEAS_EN_GPIO_PORT                          GPIOA
#define VBAT_MEAS_EN_GPIO_CLK_ENABLE()                  __HAL_RCC_GPIOA_CLK_ENABLE()
#define VBAT_MEAS_EN_GPIO_CLK_DISABLE()                 __HAL_RCC_GPIOA_CLK_DISABLE()
